...
locations = {
    'Amazon NL Disk': {
        'webshop': 'amazon-nl',
        'url': 'https://www.amazon.nl/dp/B08LLZ2CWD/',
        'inStock': False,
    ...
    'Amazon NL Digital': {
        'webshop': 'amazon-nl',
        'url': 'https://www.amazon.nl/dp/B08JDQLQYV/',
        'inStock': False,
        'inStockLabel': "submit.add-to-cart-announce",
        'outOfStockLabel': "Momenteel niet verkrijgbaar",
        'detectedAsBotLabel': "please contact api-services-support@amazon.com"},
    'Amazon IT Disk': {
        'webshop': 'amazon-it',
        'url': 'https://www.amazon.it/dp/B08LLZ2CWD/',
        'inStock': False,
        'inStockLabel': "submit.add-to-cart-announce",
    ...
    'Amazon FR Disk': {
        'webshop': 'amazon-fr',
        'url': 'https://www.amazon.fr/dp/B0951BK1S6/',
        'inStock': False,
        'inStockLabel': "submit.add-to-cart-announce",
    ...
    'Amazon ES Disk': {
        'webshop': 'amazon-es',
        'url': 'https://www.amazon.es/dp/B09DT5MB16/',
        'inStock': False,
        'inStockLabel': "submit.add-to-cart-announce",
    ...
    #        'outOfStockLabel': "uitverkocht!",
    #        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'NEDGAME Digital met extra controller en headset': {
        'webshop': 'nedgame',
        'url': 'https://www.nedgame.nl/playstation-5/playstation-5-digital-edition-bundel/3831177925/',
        'inStock': False,
    ...
    'Dreamland BE Digital': {
        ...
        'outOfStockLabel': "Niet in voorraad",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'Dreamland BE Disk met controller': {
        'webshop': 'fun-be',
        ...
        'outOfStockLabel': "Niet in voorraad",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
    'Dreamland BE Digital met controller': {
        'webshop': 'fun-be',
        'url': 'https://www.dreamland.be/e/nl/dl/playstation-5-console-digital-edition-wit-ps5-dualsense-controller-125027',
        'inStock': False,
        'inStockLabel': "In winkelwagen",
        'outOfStockLabel': "Niet in voorraad",
        'detectedAsBotLabel': "detectedAsBotPlaceholderLabel"},
